...
public class GUIfields {
    ...
    public GUI_Field[] CreatGUI(){
        ...
        gui_field[2]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.GRAY,Color.green);
        ...
        gui_field[7]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.gray,Color.green);
        ...
        gui_field[10]= new GUI_Jail();

        gui_field[10].setTitle("På besøg");
        ...
        gui_field[17]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.gray,Color.green);
        ...
        gui_field[22]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.gray,Color.green);
        ...
        gui_field[30]= new GUI_Jail();
        gui_field[30].setTitle("De fængsles");gui_field[30].setSubText("De fængsles");
        ...
        gui_field[33]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.gray,Color.green);
        ...
        gui_field[36]= new GUI_Chance("?","prøv lykken","Tage et chance kort", Color.gray,Color.green);
